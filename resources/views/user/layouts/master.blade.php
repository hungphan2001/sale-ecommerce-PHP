    ...
    <div class="offcanvas-menu-wrapper">
        <div class="offcanvas__option">
            ...
            <div class="offcanvas__links">
                ...
                <div>
                    <a href="{{ route('me.index') }}">Thông tin cá nhân</a>
                </div>
            </div>
            @else
            <div class="offcanvas__links">
        ...
        <div class="offcanvas__nav__option">
            ...
            <a href="#"><img src="{{ asset('img/icon/cart.png') }}" alt=""> <span class="count-cart">0</span></a>
            <div class="price" style="color: #e53637">0.00 vnd</div>
        </div>
        <div id="mobile-menu-wrap"></div>
        <div class="offcanvas__links mb-3">
                                ...
                                <nav class="header__menu p-0">
                                    <ul>
                                        <li>
                                            ...
                                            <ul class="dropdown" style="width: 200px; left: -100%;">
                                                <li>
                                                    <a href="{{ route('me.index') }}" >Thông tin cá nhân</a>
                                                </li>
                                                <li>
