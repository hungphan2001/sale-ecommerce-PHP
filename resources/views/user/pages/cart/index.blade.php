                                        ...
                                        <tr>
                                            <td class="product__cart__item">
                                                ...
                                                <div class="product__cart__item__text">
                                                    ...
                                                    @else
                                                        <h5>
                                                            {{ get_price_sale($cart->product->discount, $cart->product->price). '₫' }}
                                                            <span style="font-weight: normal; text-decoration: line-through; font-size: 12px">{{ number_format($cart->product->price) . ' ₫' }}</span>
                                                        </h5>
                                                    @endif
                                                </div>
                                            </td>
                                            ...
                                            <td class="cart__price">
                                                @php
                                                    $price = $cart->product->discount ?
                                                                get_price_sale($cart->product->discount, $cart->product->price, false) :
                                                                $cart->product->price
                                                @endphp
                                                {{ number_format($price * $cart->quantity) . '₫' }}</td>
